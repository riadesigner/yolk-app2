...
import useSchools from './useSchools.js';
import useSoftSkills from './useSoftSkills.js';
import useHardSkills from './useHardSkills.js';
...
export default function useFetchDesigner({ setErrorMessage }) {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        if (response.data.success) {
          ...
          // Education
          let userSchools = user?.userInfo?.schools || [
    ...
    void fetchUser();
  }, [navigate, setHardSkills, setSchools, setSoftSkills]);

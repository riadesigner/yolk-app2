import styles from './DesignerInfoEditPage.module.css';
import Field from '../../../components/Field.jsx';
import Breadcrumb from '../../../components/Breadcrumb.jsx';
import ErrorMessage from '../../../components/ErrorMessage.jsx';
import useFetchDesigner from '../../../hooks/useFetchDesigner.js';
            ...
            <div className="block mb-6">
              ...
              <div className={styles.schools}>
                {schools.map((school) => (
                  <div className="box" key={school.id}>
                    <Field
                      ...
                      value={school.title}
                      onChange={(val) =>
                        handleSchoolChange(school.id, 'title', val)
                      }
                    />
                    <Field
                      name="speciality"
                      ...
                      onChange={(val) =>
                        handleSchoolChange(school.id, 'speciality', val)
                      }
                    />
                    <Field
                      name="year"
                      ...
                      value={school.year}
                      onChange={(val) =>
                        handleSchoolChange(school.id, 'year', val)
                      }
                    />
                    <Field
                      name="city"
                      ...
                      value={school.city}
                      onChange={(val) =>
                        handleSchoolChange(school.id, 'city', val)
                      }
                    />
                ...
                <div className={styles.addSchoolBox}>
                  <button
                    className="button is-link is-inverted is-small-mobile"
                    onClick={addSchool}
                  >
                    Добавить еще
                  </button>
                      ...
                      <div key={s.id} className="columns is-1 mb-3">
                        <div className="column is-9 ">
                          <Field
                            ...
                            value={s.title}
                            onChange={(val) =>
                              handleSoftSkillChange(s.id, 'title', val)
                            }
                        ...
                        <div className="column is-2">
                          <Field
                            ...
                            value={s.percent}
                            onChange={(val) =>
                              handleSoftSkillChange(s.id, 'percent', val)
                            }
                            placeHolder="100"
                          />
                        </div>
                      ...
                      <div key={s.id} className="columns is-1 mb-3">
                        <div className="column is-9 ">
                          <Field
                            ...
                            value={s.title}
                            onChange={(val) =>
                              handleHardSkillChange(s.id, 'title', val)
                            }
                            placeHolder="UI/UX"
                          />
                        </div>
                        <div className="column is-2">
                          <Field
                            ...
                            value={s.percent}
                            onChange={(val) =>
                              handleHardSkillChange(s.id, 'percent', val)
                            }
                            placeHolder="100"
                          />
                        </div>

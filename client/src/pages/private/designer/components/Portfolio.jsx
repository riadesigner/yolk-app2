...
const portfolioItems = [
  {
    id: '1',
    title: 'Проект с длинным названием, 2025',
    img: img1,
    linkTo: '',
  },
  ...
  {
    id: '3',
    title: 'Фирменный стиль для компании Новый день, 2012',
    img: img3,
    linkTo: '',
  },
  {
    id: '4',
    title: 'Разработка логотипа для рекламной кампании Opel, Москва, 2010',
    img: '',
    linkTo: '',
  },
  {
    id: '5',
    title:
      'Разработка иллюстраций для книги Сказки волщебного лотоса, Владивосток, 2016',
    img: '',
    linkTo: '',
  },
  {
    id: '6',
    title: 'Разработка оформления праздничного городского трамвая, 2001',
    img: '',
    linkTo: '',
  },
];

export default function Portfolio({ items = portfolioItems, publicMode }) {

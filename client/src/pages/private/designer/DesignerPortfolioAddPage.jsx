...
import useFetchDesignerPortfolioAdd from '../../../hooks/useFetchDesignerPortfolioAdd.js';

export default function DesignerPortfolioAddPage() {
  const [errorMessage, setErrorMessage] = useState('');

  const { title, setTitle, description, setDescription, hdlSavePortfolio } =
          ...
          <div className="section ">
            ...
            <div className="block has-text-right">
              <button
                ...
                onClick={(val) => hdlSavePortfolio(val)}
              >
                Сохранить
              </button>
            </div>

    ...
    <>
      ...
      <article>
        <section className="container">
          <div className="section ">
            <h2 className="is-size-3 is-size-4-mobile mb-5">
          ...
          <div className="section ">
            <div className={styles.files}>
              ...
              {order && !order.contractor && files.length < 10 && (
                ...
                >
                  <FileUploader orderId={order.id} setFiles={setFiles} />
                </div>
              )}
        ...
        {order && !order.contractor && (
          <section className="container">
            <div className="section">
              <p>
                Вы можете{' '}
                <a href="#" onClick={(e) => hdlRemoveOrder(e)}>
                  удалить заказ
                </a>
                , пока не назначен Исполнитель
              </p>
              {showConfirmToDeleteOrder && (
                <p>
                  ...
                  <a
                    href="#"
                    className="is-danger"
                    onClick={(e) => hdlRemoveOrderConfirmed(e)}
                  >
                    Удалить Заказ
                  </a>
                  &nbsp;&nbsp;|&nbsp;&nbsp;
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      setShowConfirmToDeleteOrder(false);
                    }}
                  >
                    Отмена
                  </a>

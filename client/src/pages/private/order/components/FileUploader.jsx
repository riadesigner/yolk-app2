...
import docIcon from '../../../../i/document.png';
...
const FileUploader = ({ orderId, setFiles, file = null, nodelete = false }) => {
  ...
  const handleFileChange = (e) => {
    ...
    if (!allowedTypes.includes(file.type)) {
      setError(
        'Пожалуйста, выберите файл документа (Word, Excell, PowerPoint или PDF)'
      );
  ...
  return (
    <div style={{ maxWidth: '600px' }}>
      {!file && (
        <>
          <h2 className="title is-size-5 mb-2">Добавить файл</h2>
          <p className="is-primary">(.pdf,.doc,.ppt,.xls...)</p>

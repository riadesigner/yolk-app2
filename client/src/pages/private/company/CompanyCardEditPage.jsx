...
import styles from './CompanyCardEditPage.module.css';
import Field from '../../../components/Field.jsx';
import useFetchCompanyCard from '../../../hooks/useFetchCompanyCard.js';
      ...
      <article>
        <section className="container">
          <div className="section">
            <div className="level mb-5">
              <div className="level-item">
                <h2 className="is-size-3 is-size-4-mobile mb-0 mb-1-mobile">
                  Карточка компании
                </h2>
              </div>
            </div>
          ...
          <div className="section">
            <div className="box">
              <div className="level">
                <div className="level-item">Тип юр. лица:</div>
                <div className="level-item is-right">
                  <div className="tabs">
                    <ul>
                      <li className={legalType === 'ООО' ? 'is-active' : ''}>
                        <a href="#" onClick={(e) => handleTabClick(e, 'ООО')}>
                          ООО
                        </a>
                      </li>
                      <li className={legalType === 'ИП' ? 'is-active' : ''}>
                        <a href="#" onClick={(e) => handleTabClick(e, 'ИП')}>
                          ИП
                        </a>
                      </li>
                    </ul>
          ...
          <div className="section">
            <div className={styles.info2}>
              <div className="box">
                ...
                <div className={styles.info}>
                  <p className="subtitle is-size-7">Наименование банка:</p>
                  <Field value={bankName} onChange={setBankName} />
                  <p className="subtitle is-size-7">Р/с:</p>
                  <Field
                    value={bankRS}
                    onChange={setBankRS}
                    placeHolder="20 симолов"
                  />
                  <p className="subtitle is-size-7">К/с:</p>
                  <Field
                    value={bankKS}
                    onChange={setBankKS}
                    placeHolder="20 симолов"
                  />
                  <p className="subtitle is-size-7">БИК:</p>
                  <Field
                    value={bankBIK}
                    onChange={setBankBIK}
                    placeHolder="9 симолов"
                  />
                </div>
              </div>
              <div className="box">
                ...
                <div className={styles.info}>
                  {legalType === 'ООО' && (
                    <>
                      <p className="subtitle is-size-7">ИНН:</p>
                      <Field
                        value={codeINN}
                        onChange={setCodeINN}
                        placeHolder="10 симолов"
                      />
                      <p className="subtitle is-size-7">КПП:</p>
                      <Field
                        value={codeKPP}
                        onChange={setCodeKPP}
                        placeHolder="9 симолов"
                      />
                      <p className="subtitle is-size-7">ОГРН:</p>
                      <Field
                        value={codeOGRN}
                        onChange={setCodeOGRN}
                        placeHolder="13 симолов"
                      />
                      <p className="subtitle is-size-7">ОКПО:</p>
                      <Field
                        value={codeOKPO}
                        onChange={setCodeOKPO}
                        placeHolder="8 симолов"
                      />
                    </>
                  )}
                  {legalType === 'ИП' && (
                    <>
                      ...
                      <Field
                        ...
                        placeHolder="10 симолов"
                      />
                      <p className="subtitle is-size-7">ОГРНИП:</p>
                      <Field
                        value={codeOGRN}
                        onChange={setCodeOGRN}
                        placeHolder="13 симолов"

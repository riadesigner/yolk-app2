export default function UserAgreePage() {
  return (
    <>
        ...
        <div className="section">
          <div className="article">
            <article>
              ...
              <p>
                1.1 ООО «ЙОЛК» (далее по тексту – Оператор) ставит соблюдение
                прав и свобод граждан одним из важнейших условий осуществления
                своей деятельности.
              </p>
              <p>
                ...
                beyolk.ru. Персональные данные обрабатывается в соответствии с
              ...
              <p>2.2 Пользователь – любой посетитель веб-сайта beyolk.ru;</p>
              <p>
                2.3 Персональные данные – любая информация, относящаяся к
                Пользователю веб-сайта <strong>beyolk.ru</strong>;
              </p>
              <p>
                2.4 Обработка персональных данных - любое действие с
                персональными данными, совершаемые с использованием ЭВМ, равно
              ...
              <p>
                3.2. Кроме того, на сайте происходит сбор и обработка
                обезличенных данных о посетителях (в т.ч. файлов «cookie») с
                помощью сервисов интернет-статистики (Яндекс Метрика, Гугл
                Аналитика и других).
              </p>
              ...
              <p>
                ...
                <a href="mailto:yolk.ru@yandex.ru">yolk.ru@yandex.ru</a>
              </p>
              <p>
              ...
              <p>
                ...
                только в случае их отправки Пользователем через формы,
                расположенные на веб-сайте beyolk.ru. Отправляя свои
              ...
              <p>
                ...
                Оператора{' '}
                <a href="mailto:yolk.ru@yandex.ru">yolk.ru@yandex.ru</a>, либо
                на почтовый адрес Оператора Приморский край, г Владивосток, ул
                Кирова, д. 14/2, кв. 136, с пометкой «Актуализация персональных
                данных».
              </p>
              <p>
                ...
                <a href="mailto:yolk.ru@yandex.ru">yolk.ru@yandex.ru</a>, либо
                на почтовый адрес Оператора Приморский край, г Владивосток, ул
                Кирова, д. 14/2, кв. 136, с пометкой «Отзыв согласия на

                      ...
                      return (
                        <div key={file.key || index}>
                          <a target="_blank" href={file.url} rel="noreferrer">
                            <button className="button mb-2 mr-2">
                              {file.originalName}
                            </button>
                          </a>
                        </div>
                ...
                <div className={styles.details}>
                  <div className="box">
                    ...
                    <div className="block">
                      ...
                      <div className="is-primary is-size-5">
                        {order && order.price} руб.
                      </div>
                    </div>
                    <div className="block">
                      <div className="mb-1">Выполнить до</div>
                      <div>
                        {order && order.dateTo && order.dateTo.split('T')[0]}
                      </div>
                    </div>
                    <div className="block">
                      <div className="mb-1">Заказчик</div>
                      {order && order.company && (
                        <Link to={'/companies/' + order.company.id}>
                          {order.company.name}
                        </Link>
                      )}
                    </div>

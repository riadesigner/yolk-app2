...
import useImageUploaderForPortfoliio from '../../../hooks/useImageUploaderForPortfolio.js';

export default function ImageUploaderPortfolio({
  portfolioId,
  setImages,
  image = null,
}) {
...
ImageUploaderPortfolio.propTypes = {
